...
class PaperProcessor:
    ...
    def get_labels(self):
        return ['environmental modeling & assessment',
...
def main(_):
    ...
    if FLAGS.do_eval:
        ...
        with tf.gfile.GFile(output_eval_file, "w") as writer:
            ...
            tf.logging.info("***** Eval results *****: {}".format(best_checkpoint))
