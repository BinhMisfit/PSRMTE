...
def get_task(config: configure_finetuning.FinetuningConfig, task_name,
  ...
  if task_name == "cs-paper":
    return classification_tasks.CSPaper(config, tokenizer)
  elif task_name == "cs-paper-v2":
    return classification_tasks.CSPaperV2(config, tokenizer)
  elif task_name == "springer-paper":
    return classification_tasks.SpringerPaper(config, tokenizer)
  elif task_name == "springer-paper-v2":
    return classification_tasks.SpringerPaperV2(config, tokenizer)
  elif task_name == "cola":
